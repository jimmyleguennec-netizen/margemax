...
export default function AuthLayout({
  ...
  return (
    <InteractiveGrid>
      <div className="relative flex min-h-[100dvh] flex-col items-center justify-center gap-8 overflow-x-clip bg-[#05050a] px-4 py-8 pb-[max(2rem,env(safe-area-inset-bottom))]">
        <div
          aria-hidden
